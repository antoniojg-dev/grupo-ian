  ...
  return (
    <main className="p-6 lg:p-8">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="font-quicksand text-sm text-gray-500 mb-8">Gestión de cupones de descuento</p>
        <div className="bg-white rounded-2xl shadow-sm p-10 text-center">
          ...
          <p className="font-quicksand text-sm text-gray-400">
            Aquí podrás crear y gestionar cupones de descuento para colegiaturas e inscripciones.
          </p>
        </div>
      </div>
    </main>
